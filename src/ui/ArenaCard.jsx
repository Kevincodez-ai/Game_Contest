export default function ArenaCard({ side, accentColor, glowColor, title, subtitle, tags, description, nextArena, width }) {
    ...
    return (
        <div style={{ position: "relative", width: width || "100%", maxWidth: "360px", boxSizing: "border-box", padding: "24px 20px", background: "rgba(0,0,0,0.75)", border: `1px solid ${accentColor}55`, borderRadius: "14px", backdropFilter: "blur(10px)", boxShadow: `0 0 24px ${glowColor}33, inset 0 0 30px ${glowColor}11`, animation: "cardFloat 4s ease-in-out infinite", overflow: "hidden" }}>
            ...
            <div style={{ color: accentColor, fontFamily: "'Clash Display', sans-serif", fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", marginBottom: "6px", opacity: 0.8 }}>{subtitle}</div>
            <div style={{ color: "#fff", fontFamily: "'Clash Display', sans-serif", fontSize: "18px", fontWeight: "bold", letterSpacing: "1px", marginBottom: "12px", textShadow: `0 0 10px ${glowColor}88` }}>{title}</div>
            <div style={{ height: "1px", background: `linear-gradient(90deg, ${accentColor}88, transparent)`, marginBottom: "12px" }} />
            <div style={{ color: "#cccccc", fontFamily: "'Clash Display', sans-serif", fontSize: "12px", lineHeight: "1.7", marginBottom: "14px" }}>{description}</div>
            ...
            {nextArena && (
                <div style={{ paddingTop: "10px", borderTop: `1px solid ${accentColor}33`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <span style={{ color: "#666", fontFamily: "'Clash Display', sans-serif", fontSize: "10px", letterSpacing: "1px", textTransform: "uppercase" }}>Next Arena</span>
                    <span style={{ color: accentColor, fontFamily: "'Clash Display', sans-serif", fontSize: "11px", fontWeight: "bold" }}>{nextArena} →</span>
                </div>
            )}
            <style>{`
